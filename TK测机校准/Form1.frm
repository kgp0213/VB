...
Private Sub Form_Click()
  ...
  If (num > 10) Then
   Label7.FontSize = 10
  Label7.Caption = "好了，我知道你很无聊，我还是告诉你我的QQ号吧：690293499，我正等你呢  :)"
...
'---------------------------------
  Label7.Caption = ""
  Label11.Caption = ""
  Label12.Caption = "1，注意，若出现80xx的报错 ，即表明当前电脑串口异常，请通过电脑设备管理器检查确认；2，先校微安档，再校毫安档"
    ...
    '===========================================
       ' cf = MSComm1.Input
          If InStr(cf, "#uA#") > 0 Then
            ...
            Label7.Caption = "校准ing......"
                If (flagstart < 1) Or (flagstart > 2) Then        '因为uA档位只会校准2次，故flagstart超过2则意味着异常
